...
var temp = require('../lib/api');

var makeRequest = temp.makeRequest;
var verifyParameters = temp.verifyParameters;
...
var computerVision = function computerVision(key) {
    ...
    */
    self.analyzeImage = function (_ref) {
        ...
        var operation = {
            ...
            "parameters": [{
                ...
                "value": "Categories",
                "options": ["ImageType", "Faces", "Adult", "Categories", "Color", "Tags", "Description"],
                "required": false,
                "kind": 2,
                "typeName": "string"
            }, {
        ...
        return verifyParameters(operation, parameters).then(makeRequest({
            operation: operation,
    ...
    */
    self.describeImage = function (_ref2) {
    ...
    */
    self.getThumbnail = function (_ref3) {
    ...
    Example Parameters: {}
    */
    self.listDomainSpecificModels = function (_ref4) {
    ...
    */
    self.recognizeDomainSpecificContent = function (_ref6) {
